...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and jinxiangcoin: URIs)"));
    ...
    openAction->setStatusTip(tr("Open a jinxiangcoin: URI or payment request"));
