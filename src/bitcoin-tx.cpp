...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s jinxiangcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  jinxiangcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded jinxiangcoin transaction") + "\n" +
              "  jinxiangcoin-tx [options] -create [commands]   " + _("Create hex-encoded jinxiangcoin transaction") + "\n" +
              "\n";
