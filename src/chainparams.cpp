...
public:
    CMainParams() {
        ...
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-a.jinxiangcoin.loshan.co.uk", true));
        vSeeds.push_back(CDNSSeedData("thrasher.io", "dnsseed.thrasher.io", true));
        vSeeds.push_back(CDNSSeedData("jinxiangcointools.com", "dnsseed.jinxiangcointools.com"));
        vSeeds.push_back(CDNSSeedData("jinxiangcoinpool.org", "dnsseed.jinxiangcoinpool.org"));
...
public:
    CTestNetParams() {
        ...
        vSeeds.push_back(CDNSSeedData("jinxiangcointools.com", "testnet-seed.jinxiangcointools.com"));
        vSeeds.push_back(CDNSSeedData("loshan.co.uk", "seed-b.jinxiangcoin.loshan.co.uk", true));
